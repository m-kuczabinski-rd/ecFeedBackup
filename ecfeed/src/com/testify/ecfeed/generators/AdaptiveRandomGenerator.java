...
public class AdaptiveRandomGenerator<E> extends AbstractGenerator<E> {
	public final String EXECUTED_SET_SIZE_PARAMETER_NAME = "Executed set size";
	public final int DEFAULT_EXECUTED_SET_SIZE_VALUE = -1;
	...
	public final String TEST_SUITE_SIZE_PARAMETER_NAME = "Test suite size";
	...
	public AdaptiveRandomGenerator() throws GeneratorException{
		addParameterDefinition(new IntegerParameter(EXECUTED_SET_SIZE_PARAMETER_NAME, 
				false, DEFAULT_EXECUTED_SET_SIZE_VALUE, -1, Integer.MAX_VALUE));
	...
	public void initialize(List<List<E>> inputDomain,
		...
		int executedSetSize = getIntParameter(EXECUTED_SET_SIZE_PARAMETER_NAME);
