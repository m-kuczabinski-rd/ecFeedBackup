...
public class Messages {
	...
	public static final String PARTITION_NAME_REGEX_PROBLEM = "Choice name must contain between 1 and 64 characters and must not contain only white space characters";
