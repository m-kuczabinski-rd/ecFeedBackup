...
public class ModelUtils {
	...
	public static String getDefaultExpectedValueString(String type) {
		switch(type){
		case com.testify.ecfeed.modelif.Constants.TYPE_NAME_BYTE:
			return Constants.DEFAULT_EXPECTED_BYTE_VALUE;
		case com.testify.ecfeed.modelif.Constants.TYPE_NAME_BOOLEAN:
			return Constants.DEFAULT_EXPECTED_BOOLEAN_VALUE;
		case com.testify.ecfeed.modelif.Constants.TYPE_NAME_CHAR:
			return Constants.DEFAULT_EXPECTED_CHAR_VALUE;
		case com.testify.ecfeed.modelif.Constants.TYPE_NAME_DOUBLE:
			return Constants.DEFAULT_EXPECTED_DOUBLE_VALUE;
		case com.testify.ecfeed.modelif.Constants.TYPE_NAME_FLOAT:
			return Constants.DEFAULT_EXPECTED_FLOAT_VALUE;
		case com.testify.ecfeed.modelif.Constants.TYPE_NAME_INT:
			return Constants.DEFAULT_EXPECTED_INT_VALUE;
		case com.testify.ecfeed.modelif.Constants.TYPE_NAME_LONG:
			return Constants.DEFAULT_EXPECTED_LONG_VALUE;
		case com.testify.ecfeed.modelif.Constants.TYPE_NAME_SHORT:
			return Constants.DEFAULT_EXPECTED_SHORT_VALUE;
		case com.testify.ecfeed.modelif.Constants.TYPE_NAME_STRING:
	...
	private static String getTypeName(ILocalVariable parameter, IMethod method, Class<?> testClass) {
		...
		case Signature.SIG_BOOLEAN:
			return com.testify.ecfeed.modelif.Constants.TYPE_NAME_BOOLEAN;
		case Signature.SIG_BYTE:
			return com.testify.ecfeed.modelif.Constants.TYPE_NAME_BYTE;
		case Signature.SIG_CHAR:
			return com.testify.ecfeed.modelif.Constants.TYPE_NAME_CHAR;
		case Signature.SIG_DOUBLE:
			return com.testify.ecfeed.modelif.Constants.TYPE_NAME_DOUBLE;
		case Signature.SIG_FLOAT:
			return com.testify.ecfeed.modelif.Constants.TYPE_NAME_FLOAT;
		case Signature.SIG_INT:
			return com.testify.ecfeed.modelif.Constants.TYPE_NAME_INT;
		case Signature.SIG_LONG:
			return com.testify.ecfeed.modelif.Constants.TYPE_NAME_LONG;
		case Signature.SIG_SHORT:
			return com.testify.ecfeed.modelif.Constants.TYPE_NAME_SHORT;
		case "QString;":
			return com.testify.ecfeed.modelif.Constants.TYPE_NAME_STRING;
		default:
			...
			return com.testify.ecfeed.modelif.Constants.TYPE_NAME_UNSUPPORTED;
		}
	}
	...
	public static boolean validateNodeName(String name){
		if(name.length() < 1 || name.length() > com.testify.ecfeed.modelif.Constants.MAX_NODE_NAME_LENGTH) return false;
	...
	public static boolean validatePartitionStringValue(String valueString, String type) {
		...
		if (valueString.length() > com.testify.ecfeed.modelif.Constants.MAX_NODE_NAME_LENGTH) return false;
	...
	public static ArrayList<String> getJavaTypes() {
		...
		types.add(com.testify.ecfeed.modelif.Constants.TYPE_NAME_BOOLEAN);
		types.add(com.testify.ecfeed.modelif.Constants.TYPE_NAME_BYTE);
		types.add(com.testify.ecfeed.modelif.Constants.TYPE_NAME_CHAR);
		types.add(com.testify.ecfeed.modelif.Constants.TYPE_NAME_SHORT);
		types.add(com.testify.ecfeed.modelif.Constants.TYPE_NAME_INT);
		types.add(com.testify.ecfeed.modelif.Constants.TYPE_NAME_LONG);
		types.add(com.testify.ecfeed.modelif.Constants.TYPE_NAME_FLOAT);
		types.add(com.testify.ecfeed.modelif.Constants.TYPE_NAME_DOUBLE);
		types.add(com.testify.ecfeed.modelif.Constants.TYPE_NAME_STRING);
		return types;
	}
}
