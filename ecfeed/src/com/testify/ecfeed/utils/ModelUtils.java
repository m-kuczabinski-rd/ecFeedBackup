...
public class ModelUtils {
	...
	public static boolean validateNodeName(String name){
		if(name.length() < 1 || name.length() > com.testify.ecfeed.modelif.java.Constants.MAX_NODE_NAME_LENGTH) return false;
	...
	public static boolean validatePartitionStringValue(String valueString, String type) {
		...
		if (valueString.length() > com.testify.ecfeed.modelif.java.Constants.MAX_NODE_NAME_LENGTH) return false;
...
//			return ClassUtils.isPartitionImplemented(node.getExactValueString(), node.getCategory().getType(), loader);
	...
	public static ArrayList<String> getJavaTypes() {
		...
		types.add(com.testify.ecfeed.modelif.java.Constants.TYPE_NAME_BOOLEAN);
		types.add(com.testify.ecfeed.modelif.java.Constants.TYPE_NAME_BYTE);
		types.add(com.testify.ecfeed.modelif.java.Constants.TYPE_NAME_CHAR);
		types.add(com.testify.ecfeed.modelif.java.Constants.TYPE_NAME_SHORT);
		types.add(com.testify.ecfeed.modelif.java.Constants.TYPE_NAME_INT);
		types.add(com.testify.ecfeed.modelif.java.Constants.TYPE_NAME_LONG);
		types.add(com.testify.ecfeed.modelif.java.Constants.TYPE_NAME_FLOAT);
		types.add(com.testify.ecfeed.modelif.java.Constants.TYPE_NAME_DOUBLE);
		types.add(com.testify.ecfeed.modelif.java.Constants.TYPE_NAME_STRING);
		return types;
	}
}
