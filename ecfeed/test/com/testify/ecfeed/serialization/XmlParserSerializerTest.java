...
//	private final int MAX_EXPECTED_CATEGORIES = 3;
	...
	public void parsePartitionTest(){
		try{
			...
			CategoryNode category = new CategoryNode("category", com.testify.ecfeed.gal.Constants.TYPE_NAME_STRING, false);
	...
	public void parseConditionStatementTest(){
		try{
			...
			CategoryNode partitionedCategory = 
					new CategoryNode("partitionedCategory", com.testify.ecfeed.gal.Constants.TYPE_NAME_STRING, false);
			CategoryNode expectedCategory = 
					new CategoryNode("expectedCategory", com.testify.ecfeed.gal.Constants.TYPE_NAME_CHAR, true);
...
//			}
	...
	private CategoryNode createPartitionedCategory(String type, int numOfPartitions) {
		CategoryNode category = new CategoryNode(randomName(), type, false);
