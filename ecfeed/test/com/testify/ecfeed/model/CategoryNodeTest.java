...
public class CategoryNodeTest extends CategoryNode {
	...
	public void testGetBooleanValueFromString() {
		...
		assertTrue(category.isStringValueValid("true"));
		assertTrue(category.isStringValueValid("True"));
		assertTrue(category.isStringValueValid("TRUE"));
		assertTrue(category.isStringValueValid("false"));
		assertTrue(category.isStringValueValid(""));
		assertTrue(category.isStringValueValid("anything"));
