...
import com.testify.ecfeed.runner.ParameterizedFrameworkMethod;
...
public class RuntimeFeeder extends BlockJUnit4ClassRunner {
	...
	private List<List<PartitionNode>> fInput = new ArrayList<List<PartitionNode>>();
	...
	private ParameterizedFrameworkMethod createTestMethod(
			FrameworkMethod method, TestCaseNode testCase) {
		...
		return new ParameterizedFrameworkMethod(method.getMethod(),
				testParameters);
	}
